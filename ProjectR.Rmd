...
image_resize(c(plot1, plot2), '300x200!') %>%
  image_background('white') %>%
  image_morph() %>%
  image_animate(optimize = TRUE)
```
#Animation proves there is no significant difference in the two chromatograms so mixing the corresponding fractions was a good call. It is nice to see the reproducibility of elution times. Next time it would be nice to add fraction names on the image.
